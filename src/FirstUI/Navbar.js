...
<<<<<<< HEAD
                    ...
                    <Button size="small"  title="Notification" style={{ position: "absolute", left: "-15rem", top: "2rem", borderRadius: "25rem" }} ><NotificationsIcon style={{ fontSize: "45rem"}} className= "icon_nav" /></Button>
